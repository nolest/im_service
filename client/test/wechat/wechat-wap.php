...
//****************** pc版头部通用 start ******************
$pc_wap = 'wap/';
$tpl = $my_app_pai->getView(TASK_TEMPLATES_ROOT.$pc_wap.'wechat_room/wechat.tpl.htm');
...
$tpl->assign('machine',G_PHP_COMMON_ENVIRONMENT_TYPE);
$tpl->assign('timeshot',strtotime(date('Y-m-d H:i:s')));
?>
